...
print('Lista orinignal: ', mi_lista)
...
print("Lista despues de actualizar un ranto de elementos: ", mi_lista)

#Actualizar basado en una condicion
for i in range(len(mi_lista)):
    if mi_lista[i]>30:
        mi_lista[i] += 10
print("Lista despues de actualizar elementos mayores de 30: ", mi_lista)
